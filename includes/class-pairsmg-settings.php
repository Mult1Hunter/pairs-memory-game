...
class PairsMG_Settings {
    ...
    public static function defaults() {
        return array(
            ...
            'color_ink'           => '#3e2f27',
            'color_accent'        => '#594a41',
            'color_success'       => '#6b7a4a',
            'color_card_back'     => '#56554a',
            'color_card_frame'    => '#d5ab69',
            'font_mode'           => 'bundled',
            'card_ratio'          => '7:10',
            'corner_radius'       => 0,
    ...
    public static function theme_presets() {
        return array(
            ...
            'light' => array(
                ...
                'color_accent' => '#2563eb', 'color_success' => '#15803d',
                'color_card_back' => '#1e3a8a', 'color_card_frame' => '#93c5fd',
            ),
            'dark' => array(
